...
const defaults = {
  loglevel: process.env.PIECEWISE_SAAS_LOG_LEVEL || 'error',
  cfaccess: {
    audience: process.env.PIECEWISE_SAAS_CFACCESS_AUDIENCE,
    url: process.env.PIECEWISE_SAAS_CFACCESS_URL,
  },
  db: {
    host: process.env.PIECEWISE_SAAS_DB_HOST || 'localhost',
    port: process.env.PIECEWISE_SAAS_DB_PORT || 5432,
    database: process.env.PIECEWISE_SAAS_DB_DATABASE || 'piecewise-saas',
    user: process.env.PIECEWISE_SAAS_DB_USERNAME || 'piecewise-saas',
    password: process.env.PIECEWISE_SAAS_DB_PASSWORD,
    pool_min: process.env.PIECEWISE_SAAS_DB_POOL_MIN || 0,
